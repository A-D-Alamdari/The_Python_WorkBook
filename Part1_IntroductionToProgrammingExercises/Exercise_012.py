...
t1 = math.radians(float(input("Enter the latitude of the first point (in degrees): ")))
g1 = math.radians(float(input("Enter the longitude of the first point (in degrees): ")))

# Get the latitude and longitude of the second point from the user
t2 = math.radians(float(input("Enter the latitude of the second point (in degrees): ")))
g2 = math.radians(float(input("Enter the longitude of the second point (in degrees): ")))

# Calculate the distance using the provided formula
distance = 6371.01 * math.acos(math.sin(t1) * math.sin(t2) + math.cos(t1) * math.cos(t2) * math.cos(g1 - g2))

# Display the distance between the points
print("The distance between the points is approximately %.3f kilometers." % distance)
